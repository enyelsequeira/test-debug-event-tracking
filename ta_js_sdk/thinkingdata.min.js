!(function () {
  ...
  function d0(e, t) {
    for (
      ...
      if (
        '' !==
        (s = (s = o[p].match(/(.*?)=(.*)/)) || [o[p], o[p], ''])[1].replace(/\s/g, '')
      ) {
        if (
          ((s[2] = ((r = s[2] || ''), _.decodeURIComponent(r.replace(/\+/g, ' ')))),
          c === s[1])
        )
          return s[2];
        (n = s[1].match(/(.*)\[([0-9]+)\]/))
  ...
  (_.each = function (e, t, n) {
    ...
    (_.UUID = function () {
      ...
      return (
        e ||
        (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(
          2,
          15
        )
      );
    ...
    (_.url = function (e, t) {
      ...
      if (((e = e.toString()), (r = t.match(/^mailto:([^\/].+)/))))
        ...
        if (
          ...
          return c0(e, n.path.substring(1));
        if (
          ((r = (r = c0('/-1', n.path.substring(1))) && r.match(/(.*?)\.(.*)/)) &&
          ...
          return c0(e, n.hostname);
        a0() &&
          (r = n.hostname.match(a0())) &&
          ((n.tld = r[3]),
    ...
    (_.base64Encode = function (e) {
      ...
      for (
        ...
        (t =
          ((i =
            (e.charCodeAt(s++) << 16) | (e.charCodeAt(s++) << 8) | e.charCodeAt(s++)) >>
            12) &
          63),
          (n = (i >> 6) & 63),
          (r = 63 & i),
          (p[a++] = o.charAt((i >> 18) & 63) + o.charAt(t) + o.charAt(n) + o.charAt(r)),
          s < e.length;
    ...
    (_.addEvent = function (e, t, n, r) {
      if (document.addEventListener)
        if (
          ('Array' !== this.paramType(e) && 'HTMLCollection' !== this.paramType(e)) ||
          !e.length ||
          e === window
        )
  ...
  var Log = (function () {
    ...
    ThinkingDataPersistence = function (e) {
      ...
      this.enabled &&
        ...
        this._load(n),
        this.getDistinctId() ||
          ((e = e.uuid || _.UUID()), this._setDeviceId(e), this.setDistinctId(e));
    };
  (ThinkingDataPersistence.prototype._load = function (e) {
    ...
    (ThinkingDataPersistence.prototype.getEnableTracking = function () {
      return (
        !!_.check.isUndefined(this._state.enable_tracking) || this._state.enable_tracking
      );
    }),
    ...
    (ThinkingDataPersistence.prototype.removeEventTimer = function (e) {
      ...
      return (
        _.check.isUndefined(t) || (delete this._state.event_timers[e], this._save()), t
      );
    }),
  ...
  (ThinkingDataAnalyticsLib.prototype.trackLink = function (e, n, r) {
      ...
      PropertyChecker.properties(r) || !i
        ? e &&
          ...
          _.each(o, function (e) {
            var t;
            null !== e &&
              (((t = _.extend({}, _.info.pageProperties(), r))['#element_type'] =
                e.nodeName.toLowerCase()),
              _.check.isUndefined(t.name) &&
                (t.name =
                  e.getAttribute('td-name') || e.innerHTML || e.value || '未获取标识'),
    ...
    (ThinkingDataAnalyticsLib.prototype._sendRequest = function (e, t, n) {
      var r,
        i,
        o = _.check.isUndefined(e.time) || !_.check.isDate(e.time) ? new Date() : e.time,
        s = {
          data: [
            {
              '#type': e.type,
              '#time': _.formatDate(_.formatTimeZone(o, this._getConfig('zoneOffset'))),
      ...
      if (
        (this.persistence.getAccountId() &&
          (s.data[0]['#account_id'] = this.persistence.getAccountId()),
        'track' === e.type || 'track_update' === e.type || 'track_overwrite' === e.type
          ? ((s.data[0]['#event_name'] = e.event),
            'track_update' === e.type || 'track_overwrite' === e.type
              ? (s.data[0]['#event_id'] = e.extraId)
              : e.firstCheckId && (s.data[0]['#first_check_id'] = e.firstCheckId),
            (o = 0 - o.getTimezoneOffset() / 60),
            this._getConfig('zoneOffset') && (o = this._getConfig('zoneOffset')),
            (s.data[0].properties = _.extend(
              {},
              { '#device_id': this.persistence.getDeviceId(), '#zone_offset': o },
              _.info.properties(),
              this.getSuperProperties(),
              this.dynamicProperties ? this.dynamicProperties() : {},
              this.getPageProperty()
            )),
            (o = this.persistence.removeEventTimer(e.event)),
            _.check.isUndefined(o) ||
              ((o = new Date().getTime() - o),
              (o = parseFloat((o / 1e3).toFixed(3))),
              (s.data[0].properties['#duration'] = o = 86400 < o ? 86400 : o)))
          : (s.data[0].properties = {}),
        _.check.isObject(e.properties) &&
          !_.check.isEmptyObject(e.properties) &&
          _.extend(s.data[0].properties, e.properties),
        _.searchObjDate(s.data[0], this._getConfig('zoneOffset')),
        'ajax' === this._getConfig('send_method') &&
          (s.data[0] = _.generateEncryptyData(s.data[0], this._getConfig('secretKey'))),
        (s['#app_id'] = this._getConfig('appId')),
        (s['#flush_time'] = new Date().getTime()),
        Log.i(s),
        ...
        if ('object' === _typeof(e) && e.thinkingdata_track)
          return (
            e.thinkingdata_track(JSON.stringify(s)), void ('function' == typeof t && t())
          );
          ...
          return (
            e.setAttribute(
              ...
              'thinkinganalytics://trackEvent?event=' +
                _.encodeURIComponent(JSON.stringify(s))
            ),
      ...
      if (
        (n && (s.data[0]['#uuid'] = _.UUIDv4()),
        this._isDebug()
          ? ((i =
              '&data=' +
              _.encodeURIComponent(JSON.stringify(s.data[0])) +
        ...
        n = new FormData();
        return (
          n.append('data', r), void navigator.sendBeacon(this._getConfig('serverUrl'), n)
        );
      }
      'ajax' === this._getConfig('send_method')
        ? new AjaxTask(
      ...
      _createClass(o, [
        {
          ...
          value: function () {
            ...
            (t = window.XMLHttpRequest
              ? new XMLHttpRequest()
              : new ActiveXObject('Microsoft.XMLHTTP')).open('post', this.serverUrl, !0),
  ...
  (ThinkingDataAnalyticsLib.prototype._isDebug = function () {
    return (
      'debug' === this._getConfig('mode') || 'debug_only' === this._getConfig('mode')
    );
  }),
      ...
      ((e = window.ThinkingDataAnalyticalTool) &&
        ...
        ((tdMaster.__SV || 0) < 1.1
          ...
          : ((tdMaster.isLoadSDK = !0),
            (t = new ThinkingDataAnalyticsLib()).init(tdMaster.param),
            tdMaster._q1 &&
            ...
            'function' == typeof t._getConfig('loaded') && t._getConfig('loaded')(t),
            (window[e] = t),
            tdMaster._q &&
  ...
  (ThinkingDataAnalyticsLib.prototype.initInstance = function (e, t) {
    ...
    t.persistenceEnabled && (t.persistencePrefix = t.persistencePrefix + '_' + e),
      n.init(t),
      (this[e] = n);
  }),
